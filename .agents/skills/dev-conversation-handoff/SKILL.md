...
description: Generate a concise handoff summary so work can continue in a brand new Codex chat without losing important context. Use only when explicitly requested.
---
...
The resulting handoff should be compact enough to serve as the opening message of a brand-new Codex chat.
...
The summary must be short enough to paste directly into a brand new Codex chat as the opening message. Favor compression: a sentence beats a paragraph, a paragraph beats a code block.
