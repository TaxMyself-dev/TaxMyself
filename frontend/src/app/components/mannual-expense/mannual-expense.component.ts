...
@Component({
    ...
    imports: [ReactiveFormsModule, InputAutoCompleteComponent, InputSelectComponent, InputTextComponent, InputDateComponent],
...
export class MannualExpenseComponent {
    ...
    mannualExpenseForm = this.formBuilder.group({
        ...
        isEquipment: ["", Validators.required],
        category: [, Validators.required],
        subCategory: [, Validators.required],
        vatPercent: ["", Validators.required],
        reductionPercent: ["", Validators.required],
        taxPercent: ["", Validators.required],
        businessNumber: [, [this.showBusinessSelector() ? Validators.required : null]],
    })

    getSubCategory(category: string): void {
        this.mannualExpenseService.$selectedCategory.set(category);
    }

    selectBusiness(event: string): void {
        console.log("event: ", event);
        this.authService.setActiveBusinessNumber(event);
    }
