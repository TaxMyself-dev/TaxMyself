...
export const ROUTE_ACCESS_CONFIG: Record<AppRoute, RouteAccessEntry> = {
  [AppRoute.BOOK_KEEPING_INCOMES]:        { requiredModule: ModuleName.INVOICES,     blockedBehavior: BlockedBehavior.UPGRADE_POPUP },
  [AppRoute.BOOK_KEEPING_EXPENSES]:       { requiredModule: ModuleName.EXPENSES,     blockedBehavior: BlockedBehavior.UPGRADE_POPUP },
  [AppRoute.TRANSACTIONS]:                { requiredModule: ModuleName.OPEN_BANKING, blockedBehavior: BlockedBehavior.UPGRADE_POPUP },
  [AppRoute.FLOW_ANALYSIS]:               { requiredModule: ModuleName.OPEN_BANKING, blockedBehavior: BlockedBehavior.UPGRADE_POPUP },
  [AppRoute.VAT_REPORT]:                  { requiredModule: ModuleName.INVOICES,     blockedBehavior: BlockedBehavior.UPGRADE_POPUP },
  [AppRoute.PNL_REPORT]:                  { requiredModule: ModuleName.INVOICES,     blockedBehavior: BlockedBehavior.UPGRADE_POPUP },
  [AppRoute.ADVANCE_INCOME_TAX_REPORT]:   { requiredModule: ModuleName.INVOICES,     blockedBehavior: BlockedBehavior.UPGRADE_POPUP },
  [AppRoute.UNIFORM_FILE]:                { requiredModule: ModuleName.INVOICES,     blockedBehavior: BlockedBehavior.UPGRADE_POPUP },
  [AppRoute.DOC_CREATE]:                  { requiredModule: ModuleName.INVOICES,     blockedBehavior: BlockedBehavior.UPGRADE_POPUP },
};
