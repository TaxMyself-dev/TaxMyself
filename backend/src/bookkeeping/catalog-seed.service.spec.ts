...
describe('CatalogSeedService', () => {
  ...
  beforeEach(() => {
    ...
    catalogService = new CatalogService(categoryRepo as any, subCategoryRepo as any, accountRepo as any, sectionRepo as any, allocator, { transaction: jest.fn() } as any);
