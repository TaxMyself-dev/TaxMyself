...
entry form. Read-only investigation — no code changed. See also
`docs/features/bookkeeping/current-system.md`
...
category-level override (step 3) — intentional, not a bug, per
`docs/features/bookkeeping/current-system.md`
section 4.
