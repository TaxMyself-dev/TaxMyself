...
Status: retained deployment evidence. Codex production access is disabled; do
not execute this runbook unless Elazar explicitly changes that standing policy.
