...
> Historical baseline of the pre-redesign implementation. While the categories
> and accounting redesign is in progress, `docs/redesign/categories-redesign-master-plan.md`
> overrides this document wherever they differ.
...
| **פחת (`61300`) — רישום אוטומטי** | ✅ קיים — שנת ההפעלה נרשמת אוטומטית עם יצירת הוצאת הציוד; שנים מאוחרות נוצרות באופן אידמפוטנטי בהכנת דוח רווח והפסד. אין Cron או הרצה ידנית. טופס 1342 והיומן משתמשים באותו חישוב יחסי-יומי. המפרט המלא: `docs/depreciation-posting-behavior.md` |
